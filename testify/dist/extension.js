...
function activate(context) {
    ...
    const generateTestCommand = vscode.commands.registerCommand("testify.generateTest", (uri) => {
        let fileName = "";
        if (uri) {
        ...
        vscode.window.showInformationMessage(`Generating test file for: ${fileName}`);
    });
